 ...
 * 
 */
class PROJECTKJCLIENT_API CollisionAvoidanceMethod : public Behaviors
{
private:
	TArray<KinematicStatic>* Targets;
public:
	CollisionAvoidanceMethod(TArray<KinematicStatic>* TargetList);
	virtual ~CollisionAvoidanceMethod() = default;
